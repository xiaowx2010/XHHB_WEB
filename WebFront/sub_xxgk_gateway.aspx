...
//			ListBoxlb.SqlStr="select "+cid+",chcode,chtopic,cast(datepart(year,chputdate) as varchar(50))+'-'+(Case When datepart(month,chputdate)<10 Then '0' Else '' End)+cast(datepart(month,chputdate) as varchar(50))+'-'+(Case When datepart(day,chputdate)<10 Then '0' Else '' End)+cast(datepart(day,chputdate) as varchar(50)) as chdate from "+GetChannelDataTableName(cid)+" where chstate=0 order by chputdate desc";
		...
		private string ContentString(string cid)
		{
			string str="";
			switch(cid)
			{
				case "87":
					str="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、徐汇区环境保护局按照《中华人民共和国环境影响评价法》、《行政许可法》、《信息公开条例》以及相关法规、规章和规定的要求，公示建设项目环境影响评价行政许可受理信息。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、受理信息公示时限：环境影响评价报告书自信息发布起10个工作日，环境影响评价报告表自信息发布起5个工作日。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、公示期间，公众（包括个人、团体等）可以通过本网站电子邮件、传真或信函（以邮戳为准）方式提出意见。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;电子邮件：hpk@xh.sh.cn，传真：021-64878385。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;信函请寄至：南丹东路106号5楼 环境影响评价科 收（邮编：200030）。请在信封上注明：对XXX （建设项目）的意见。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4、信息公开后，我局将要求行政许可申请人对各方意见明确予以采纳或不采纳的处理意见，并对环评文件进行修改。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5、相关资料由外界所提供、并以行政许可申请人所提交的形式进行公开。上述资料和信息中如有错漏，使用上述信息和资料作为依据者自行承担责任。<br>";
					break;
				case "88":
					str="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、徐汇区环境保护局按照《中华人民共和国环境影响评价法》、《行政许可法》、《信息公开条例》以及相关法规、规章和规定的要求，公示建设项目环境影响评价行政许可受理信息。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、受理信息公示时限：环境影响评价报告书自信息发布起10个工作日，环境影响评价报告表自信息发布起5个工作日。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、公示期间，公众（包括个人、团体等）可以通过本网站电子邮件、传真或信函（以邮戳为准）方式提出意见。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;电子邮件：hpk@xh.sh.cn，传真：021-64878385。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;信函请寄至：南丹东路106号5楼 环境影响评价科 收（邮编：200030）。请在信封上注明：对XXX （建设项目）的意见。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4、信息公开后，我局将要求行政许可申请人对各方意见明确予以采纳或不采纳的处理意见，并对环评文件进行修改。<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5、相关资料由外界所提供、并以行政许可申请人所提交的形式进行公开。上述资料和信息中如有错漏，使用上述信息和资料作为依据者自行承担责任。<br>";
					break;
  ...
  <div class="main sub_L">
   <div class="main nk">
	...
	<div class="main box sub_xxgk_hpsp">
     <div class="main box bt"><%=GetChannelName(cid)%>的告知事项</div>
