...
<HTML>
	...
	<script runat="server" language="C#">
		private void Page_Load(object sender,System.EventArgs e)
		{
			...
			if(id!="0")
			{
				ListBoxwznr.SqlStr="select chtopic,cast(datepart(year,chputdate) as varchar(50))+'-'+cast(datepart(month,chputdate) as varchar(50))+'-'+cast(datepart(day,chputdate) as varchar(50)),fld_"+cid+"_10,fld_"+cid+"_11,chcontent from "+GetChannelDataTableName(cid)+" where chcode="+id;
			}
			else
			{
				ListBoxwznr.SqlStr="select chtopic,cast(datepart(year,chputdate) as varchar(50))+'-'+cast(datepart(month,chputdate) as varchar(50))+'-'+cast(datepart(day,chputdate) as varchar(50)),fld_"+cid+"_10,fld_"+cid+"_11,chcontent from "+GetChannelDataTableName(cid)+" where chstate=0 order by chputdate desc";
			}
		}
	</script>
...
<!--文章内容-->                
<G:ListBox id="ListBoxwznr" rows="1" alert="本栏目暂时没有内容！" style="width:513px; overflow:hidden; padding-top:5px" runat="server">
<G:Template id="Templatewznr" runat="server">
    ...
    <tr>
        <td align="left">
        <p class="font1225_gray">姓名：*</p>
        </td>
    </tr>
    <tr>
        <td align="left">
        <p class="font1225_gray">职务：*</p>
        </td>
    </tr>
    <tr>
        <td align="left">
